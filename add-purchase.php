                                ...
                                <input
                                    ...
                                    <input
                                       ...
                                       <div style="height: 62px;" class="form-group">
                                          ...
                                          <select class="continue" name="continue" data-bs-hover-animate="pulse" style="width: 271px;margin-left: auto; margin-right: auto;" id="inputState" class="form-control">
...
$('#myform').submit(function () {
 return false;
   ...
   var newbalance=0;
    function check() {
        // body...
            $.get( "api.php?action=addbill&amount="+amount+"&shipping="+shipping+"&commission="+commission+"&extra_tax="+extra_tax+"&amount_paid="+amount_paid+"&continue="+cont+"&client_id="+id+"&token="+token, function( data ) {
  ...
  if (obj['access']!="0") {
    ...
    billid=obj['id'];
        ...
        alert("Success .");
            window.location.href = "printbill.php?id="+billid;
    ...
    $( ".htmlrow" ).append( htmlrow );
        ...
        function additem() {
            ...
            for (var i =1; i <row+1; i++) {
                ...
                notes=$(".notes"+i).val();
                if (url!="" & quantity!="") {
                    $.get( "api.php?action=add_item&url="+url+"&notes="+notes+"&quantity="+quantity+"&bill_id="+billid+"&token="+token, function( data ) {
        var obj = $.parseJSON(data);
        });
                }
      ...
      function get_balance() {
        ...
        newbalance=parseInt(commission)+parseInt(shipping)+parseInt(extra_tax)+parseInt(amount);
