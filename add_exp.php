            ...
            <div class="container text-right hero" style="margin-top: 10px;">
                <div class="row text-right" style="direction: rtl;" direction="rtl;">       
                    <div class="col text-right" direction="rtl;">                         
                        <div class="float-left image-holder" data-bs-hover-animate="pulse" style="background-image: url(&quot;assets/img/3515.jpg&quot;);width: 607px;height: 600px;padding: 0 0 20px;background-size: cover;background-color: #e8ba61;"></div>
...
$('#myform').submit(function () {
 return false;
    ...
    function check() {
        // body...
            $.get( "api.php?action=addexp&price="+price+"&notes="+notes+"&title="+title+"&client_id="+id+"&token="+token, function( data ) {
